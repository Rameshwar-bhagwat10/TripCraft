...
export class UsersController {
  ...
  @Get("me")
  @ApiOperation({
    summary: "Get current user TripCraft profile & onboarding state",
  })
  @ApiResponse({
    status: 200,
  ...
  @Patch("me")
  @ApiOperation({
    summary: "Update user profile (fullName, avatarUrl, language, currency)",
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary:
      "Save travel preferences, accessibility, and personalization settings",
  })
