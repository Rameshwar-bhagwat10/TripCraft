...
import 'package:tripcraft/features/maps/presentation/screens/trip_map_screen.dart';
...
void main() {
  testWidgets('TripMapScreen renders spatial map view, search bar and draggable sheet', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(
          home: TripMapScreen(tripId: 'test-trip-1'),
        ),
      ),
    );
    ...
    expect(find.text('Search places, food, sights...'), findsOneWidget);
    expect(find.text('Today\'s Map Route'), findsOneWidget);
